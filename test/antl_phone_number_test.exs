defmodule AntlPhonenumberTest do
  ...
  test "possible?/2" do
    ...
    refute AntlPhonenumber.possible?(truncate(plus_e164, 4), iso_country_code)
  ...
  test "localize/2" do
    ...
    assert AntlPhonenumber.localize(plus_e164, iso_country_code) == local_number
    assert AntlPhonenumber.localize(local_number, iso_country_code) == local_number

    assert_raise RuntimeError, "parsing error", fn ->
      AntlPhonenumber.localize(local_number(), "wrong iso_country_code")
    end

    assert_raise RuntimeError, "parsing error", fn ->
      AntlPhonenumber.localize(not_number(), iso_country_code)
    end
  end
